        ...
        <div className="intro">
            <div className="intro-left">
                <div className="intro-left-wrapper">
                    ...
                    <h1 className="intro-name">Kenzo</h1>
                    <div className="intro-title">
                        ...
                        <div className="intro-title-item">Blockchain Enthusiast</div>
                        </div>
                    </div>
                    <p className="intro-description">
                        I design and develop applications and websites for customers of all sizes, 
                        specializing in stylish and performant code, responsive websites, 
            ...
            <div className="intro-right">
                ...
                <img src={Photograph} alt="Photograph of myself" className="intro-image" />
            </div>
        </div> 
    )
}
