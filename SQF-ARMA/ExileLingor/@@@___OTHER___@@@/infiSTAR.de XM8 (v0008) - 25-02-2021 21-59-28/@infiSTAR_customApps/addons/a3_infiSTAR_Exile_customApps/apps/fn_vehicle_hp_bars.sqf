...
if(!isNil'VEHICLE_HP_BARS_ID')exitWith{
	...
	((uiNamespace getVariable ['RscExileXM8', displayNull]) displayCtrl VEHICLE_BARS_BTN_IDC) ctrlSetStructuredText parseText '<t color="#44CD00">Vehicle HP Bars</t>';
};
...
((uiNamespace getVariable ['RscExileXM8', displayNull]) displayCtrl VEHICLE_BARS_BTN_IDC) ctrlSetStructuredText parseText '<t color="#FF0000">Vehicle HP Bars</t>';