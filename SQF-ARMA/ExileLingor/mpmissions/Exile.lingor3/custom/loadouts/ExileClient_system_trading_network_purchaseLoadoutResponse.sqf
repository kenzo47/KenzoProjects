...
{
	if (_responseCode isEqualTo 69) then
	{
		["ErrorTitleAndText", ["Whoops!", "You are missing respect for one or more items in your loadout! Close the loadout menu and try again."]] call ExileClient_gui_toaster_addTemplateToast;
	}
	else {
