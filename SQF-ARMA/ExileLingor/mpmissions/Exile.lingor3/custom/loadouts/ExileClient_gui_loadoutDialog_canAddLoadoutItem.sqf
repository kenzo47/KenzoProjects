...
private ["_canAddItem", "_itemClassName", "_cargoItems", "_itemType", "_cargoMass", "_cargoCapacity", "_itemMass", "_item", "_compatable", "_found"]; //, "_playerRespect", "_quality", "_requiredRespect", "_playerObject", "_sessionID"
_canAddItem = true;
