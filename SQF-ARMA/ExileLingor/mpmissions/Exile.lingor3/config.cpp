...
#include "custom\custom_config.sqf" //includes Andrew's spaghetti and keeps the config.cpp readable
...
{
	#include "RECIPES\RwGRecipes\rwg_recipes.hpp"
	#include "RECIPES\ExileRecipes\exile_recipes.hpp"
	#include "RECIPES\EBMRecipes\ebm_recipes.hpp"
	#include "RECIPES\EIRecipes\EI_Recipes.hpp"
};
...
class CfgExileArsenal
{
	...
	#include "TRADERS\GlobalVehiclePriceList.hpp"

};

class CfgExileVehiclesSellPrice //Vehicle Sell Price
{
	#include "TRADERS\GlobalVehiclePriceList.hpp"
};

class CfgLoadoutWhitelist
{
	#include "custom\loadouts\CfgLoadoutWhitelist.hpp"
};
...
class CfgExileCustomCode 
{
	...
	*/
	...
	#include "custom\CfgExileCustomCode.cpp"

	//Dual Arms Client
	ExileClient_object_player_event_onInventoryClosed = "custom\dual_arms\ExileClient_object_player_event_onInventoryClosed.sqf";
	ExileClient_object_player_event_onInventoryOpened = "custom\dual_arms\ExileClient_object_player_event_onInventoryOpened.sqf"; //Happys Revive AntiDupe ---NEW with v0.65 (Enigma Revive override is combined with Dual Arms override)
	...
	//Spawn Selection Halo Jump & BaseSpawn
	#include "custom\xs\spawn\CfgBaseSpawn.hpp"

	ExileClient_gui_selectSpawnLocation_event_onSpawnButtonClick = "custom\xs\spawn\Overwrites\ExileClient_gui_selectSpawnLocation_event_onSpawnButtonClick.sqf";
	ExileClient_gui_selectSpawnLocation_show = "custom\xs\spawn\Overwrites\ExileClient_gui_selectSpawnLocation_show.sqf";
	ExileClient_gui_selectSpawnLocation_zoomToMarker = "custom\xs\spawn\Overwrites\ExileClient_gui_selectSpawnLocation_zoomToMarker.sqf";
	ExileClient_gui_selectSpawnLocation_event_onListBoxSelectionChanged = "custom\xs\spawn\Overwrites\ExileClient_gui_selectSpawnLocation_event_onListBoxSelectionChanged.sqf";
	ExileServer_object_player_createBambi = "custom\xs\spawn\Overwrites\ExileServer_object_player_createBambi.sqf";
	...
	//ExileClient_object_player_event_onInventoryOpened = "custom\dual_arms\ExileClient_object_player_event_onInventoryOpened.sqf"; //Happys Revive AntiDupe DO NOT UNCOMMENT, override is already loaded under Dual Arms Client ^^^^^

	//Claim Vehicles
	ExileClient_ClaimVehicles_network_claimRequestSend = "custom\ClaimVehicles\functions\ExileClient_ClaimVehicles_network_claimRequestSend.sqf";

	//Vehicle Sell Price calculation override
	ExileClient_util_gear_calculateSellPrice = "custom\kenzo\ExileClient_util_gear_calculateSellPrice.sqf";

	//Server Rules override with S.I.M (P)
	ExileClient_gui_xm8_slide_apps_onOpen = "custom\kenzo\ExileClient_gui_xm8_slide_apps_onOpen.sqf"; //Sniper Monkey

	//Virtual Garage
	ExileClient_object_player_initialize = "custom\VirtualGarage\ExileClient_object_player_initialize.sqf";
...
class CfgExileLootSettings
{
	...
	maximumPositionCoverage = 45;
 	 ...
 	 * cap this at 10
 	 */
	maximumNumberOfLootSpotsPerBuilding = 12;
	...
	class Flag
	{
		...
		class Actions
		{
			...
			*/
			...
			action = "execVM 'custom\AbandonTerritory\abandon.sqf';";
			};
		};
	};
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{15000,					30,			60 					}, // Level 2 
		{20000,					45,			90 					}, // Level 3
		{25000,					60,			120					}, // Level 4
		{30000,					75,			150					}, // Level 5
		{35000,					90,			180					}, // Level 6
		{40000,					105,		210					}, // Level 7
		{50000,					120,		240					}, // Level 8
		{70000,					135,		270					}, // Level 9
		{80000,					150,		300					}  // Level 10
	};
