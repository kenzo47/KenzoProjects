...
if!(_vehicle getVariable ["ExileIsPersistent", false])exitWith{[_sessionID, "toastRequest", ["ErrorTitleAndText", ["Public Garage", "Vehicle is non persistent!"]]] call ExileServer_system_network_send_to; false};
