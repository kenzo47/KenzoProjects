...
switch (_difficulty) do
{
	...
	case "difficult":
	{
		...
		_crate_items 		= (13 + (round (random 3)));
	...
	default
	{
		...
		_crate_items 		= (16 + (round (random 6)));
		_crate_backpacks 	= (5 + (round (random 1)));
	};
};
