...
/* 5  Respawn Delay */       200,                 // The respawn delay after the max group size was reached
...
/* 12 Loot group */          EZM_Decent,             // The name of the Array used to list all the possible loot for that trigger. ZLoot.sqf
...
EZM_Trigger_2 = [				 //Main Cities Only
...
/* 14 Mission Radius */      30,               
/* 15 Mission SQF */         EZM_triggerMission,    
/* 16 Loot Box */            EZM_triggerLootCrate     
];

// List all the trigger group to use here.
EZM_Triggers = [EZM_Trigger_1,EZM_Trigger_2,EZM_Trigger_3,EZM_Trigger_4,EZM_Trigger_5]; //EZM_Trigger_6 removed, no missions
