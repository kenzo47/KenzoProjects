...
(_display displayCtrl 4004) ctrlSetStructuredText parseText '<t align="center" font="RobotoMedium">BRAma Cookbook</t>';

_RecipeList = [_display,'RscListBox',5501] call apps_fnc_createctrl;
_RecipeList ctrlSetPosition [0.02, 0.1, 0.38, 0.315];
...
_RecipeTitle ctrlSetPosition [0.02,0.06,0.38,0.04];
...
_edit ctrlSetPosition [0.02, 0.425, 0.275, 0.04];
_edit ctrlCommit 0;
_string = "
	disableSerialization;
	_display = uiNamespace getVariable ['RscExileXM8', displayNull];
...
_btn ctrlSetPosition [0.3, 0.425, 0.1, 0.04];
_btn ctrlCommit 0;
