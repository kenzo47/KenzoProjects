...
[ 
	[ 
		"ZCP Alpha", // name (0)
		[[2583,6845,0],[469,9073,0],[1906,9890,0],[4222,9613,0],[6130,9213,0],[5492,8726,0],[6306,7243,0],[6860,6976,0],[6126,6977,0],[7037,5229,0]], // [[x,y,z],[x,y,z]] if using static location (1)
		...
		3, // Minimum amount of AI at the start of mission (12)
        7, // Maximum amount of AI at start of mission ( If you want it to always be a number change MIN and MAX to the same number. )
		...
		[ // array of waves of AI () (18)
			...
			,
			[
				80, // percentage of the cap time to start attack (50 = 50% of the total captime)
				3, // Amount of AI units in a group
				2, // Amount of AI groups
				200, // distance in meter form ZCP for the ai to spawn
				true // false -> all groups from 1 random location, true -> all groups from their own random location
    ...
    [
        "ZCP Bravo", // name (0)
        [[9153,8224,0],[7846,2567,0],[4274,1804,0],[4253,1140,0],[556,1154,0],[9341,5053,0],[9320,5261,0],[1270,6238,0]], // [[x,y,z],[x,y,z]] if using static location (1)
        	["Random","Random","Poptabs","Reputation"], // Reward -> Random, Poptabs, Vehicle, Buildingbox, WeaponBox , BigWeaponBox, SniperWeaponBox (2)
        ...
        1, // Maximum amount of launchers for starting AI
