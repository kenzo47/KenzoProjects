...
switch (toLower worldName) do
{
    case "lingor3":
    {
        _cities = [
            //[MainCities]
            [[3968.89,1555.44,0], 100, 'Calamar'], 
            [[5181.43,6989.8,0], 100, 'San Isabel'], 
            [[8480.59,7917.33,0], 10, 'Conotera'], 
            [[959.359,5806.69,0], 100, 'New Benio'], 
            [[6640.11,6270.39,0], 100, 'Maruko'], 
            [[5814.44,4643.62,0], 100, 'Corazon'], 
            [[4232.46,4845.09,0], 100, 'San Arulco'], 
            [[932.659,1768.52,0], 100, 'Drassen'],
            //[Cities]
            //[[808.694,9531.67,0], 50, 'City1'],
            [[2141.82,9512.32,0], 75, 'Jodido'],
            [[2521.02,10020.8,0], 75, 'Mirasol'],
            [[3197.23,9352.39,0], 75, 'Medicolin'],
            [[4046.32,9266.36,0], 75, 'Gatoro'],
            [[5448.41,9664.09,0], 75, 'Mock Village Tango'],
            [[6466.06,9774.5,0], 75, 'Mock Village Victor'],
            [[836.147,8193.61,0], 75, 'Arapesca'],
            [[1279.18,7403.05,0], 75, 'Zanjeer'],
            [[8329.08,8904.71,0], 75, 'Cemarin'],
            [[9204.46,7092.38,0], 75, 'Madron'],
            [[3274.33,6176.07,0], 75, 'Calixo'],
            [[3569.61,6422.31,0], 75, 'Aculto'],
            [[3929.6,5961.97,0], 75, 'Guayucca'],
            [[3870.79,6468.51,0], 75, 'Garibosa'],
            [[2802.54,5386.79,0], 75, 'Vidora'],
            [[2797.74,5821.37,0], 75, 'Marango'],
            [[3125.45,5919.19,0], 75, 'Fernando'],
            [[3009.43,6281.99,0], 75, 'Haciendos'],
            [[4434.42,5611.27,0], 75, 'Tucos'],
            [[2986.12,3790.55,0], 75, 'Los Peligron'],
            [[1097.21,5000.5,0], 75, 'Pocobay'],
            [[841.113,4966.88,0], 75, 'Regina Tributa'],
            [[247.405,5655.43,0], 75, 'Villa Flora'],
            [[2277.31,2675.2,0], 75, 'Barro'],
            [[3591.16,2769.76,0], 75, 'Montehofo'],
            [[4037.94,2373.97,0], 75, 'Bilbado'],
            [[2693.63,2444.77,0], 75, 'Aguado'],
            [[874.528,2574.82,0], 75, 'Gritto'],
            [[766.396,3103.37,0], 75, 'Ramona'],
            [[262.218,3012.91,0], 75, 'Pescito'],
            [[532.451,1377.96,0], 75, 'Zuela'],
            [[513.098,931.955,0], 75, 'Mercadio'],
            [[896.644,1113.17,0], 75, 'Cordo'],
            [[1165.78,715.859,0], 75, 'Alma'],
            [[7416.59,1959.04,0], 75, 'El Villon'],
            [[7691.61,2683.9,0], 75, 'Tamba'],
            [[7513.47,2976.39,0], 75, 'Monga'],
            [[7893.4,3057.84,0], 75, 'Cabara'],
            [[8306.95,2963.76,0], 75, 'Palida'],
            [[9023.72,2576.67,0], 75, 'Paredes'],
            [[8338.21,751.09,0], 75, 'Chupinka'],
            [[6690.91,3340.51,0], 75, 'Victorin'],
            [[5619.44,3158.15,0], 75, 'Prospero'],
            [[6810.47,2128.13,0], 75, 'Marcella'],
            [[3251.65,1513.02,0], 75, 'Ralon'],
            [[1787.67,611.219,0], 75, 'Medlina'],
            [[5359.22,2126.26,0], 75, 'Lagosa'],
            [[4649.35,1852.64,0], 75, 'Melana Resort'],
            [[2231.24,1850.14,0], 75, 'Matacan'],
            [[2081.54,1111.87,0], 75, 'Verto'],
            [[1095.38,2308.15,0], 75, 'Raggo'],
            [[3132.2,4606.89,0], 75, 'Morada'],
            [[3127.96,5442.95,0], 75, 'Elcanto'],
            [[3382.94,5194.69,0], 75, 'Rosalia'],
            [[4348.09,3589.58,0], 75, 'Pancho'],
            [[6845.92,4750.36,0], 75, 'Manteria'],
            [[6595.47,4257.27,0], 75, 'Sanvigado'],
            [[1330.6,1369.15,0], 75, 'Pintosa'],
            //[[2871.39,1250.94,0], 70, 'Untitled1'],
            [[4720.42,3133.52,0], 75, 'Faunaverde'],
            [[9249.93,3837.93,0], 75, 'Fantasmo']
        ];
    };
	case "chernarus":
	{
