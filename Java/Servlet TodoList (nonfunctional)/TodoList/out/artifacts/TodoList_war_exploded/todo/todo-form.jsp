...
<html>
    <head>
        <title>Todolist Management</title>
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-md navbar-dark" style="background-color: teal">
                <div>
                    <a href="https://www.kenzo47.com" class="navbar-brand">Todo App</a>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <fieldset class="form-group">
                    ...
                    <input type="text" value="<c:out value='${todo.title}' />" class="form-control" name="title" required="required" minlength="4">
                </fieldset>

                <fieldset class="form-group">
                    <label>Todo Description</label>
                    <input type="text" value="<c:out value='${todo.description}' />" class="form-control" name="description" minlength="3">
                </fieldset>
